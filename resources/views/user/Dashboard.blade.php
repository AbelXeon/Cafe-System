...
<div class="flex h-[calc(100vh-57px)] lg:h-full w-full relative">
    ...
    <!-- SECTION 3: Real-Time Chat Support (With Driver/Kitchen) -->
    <div id="section-chat" class="page-section hidden flex-1 min-h-0 bg-[#14131a]/40 w-full" x-data="chatApp('customer')" x-init="init()">
        <div class="flex h-full w-full">
            ...
            <div class="w-full sm:w-80 border-r border-[#1e1c25] flex-col shrink-0"
                ...
                <div class="p-4 sm:p-5 border-b border-[#1e1c25] shrink-0">
                    ...
                    <p class="text-stone-500 text-xs mt-0.5">Talk to your driver once an order is out for delivery</p>
                </div>
                <div class="flex-1 overflow-y-auto custom-scroll">
                    ...
                    <div x-show="conversations.length === 0" class="p-6 text-center text-stone-500 text-xs">
                        No active or past chats yet. A chat opens once a driver accepts your order.
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex-1 flex flex-col min-h-0">
                        ...
                        <div class="p-3 sm:p-4 border-t border-[#1e1c25] shrink-0">
                            <div x-show="!canSend" class="text-xs text-stone-500 text-center py-2">
                                This chat is closed. Messaging opens once a driver accepts your order and closes after it's delivered.
                            </div>
...
<script>
    ...
    function ordersApp() {
        return {
            ...
            init() {
                // Poll live orders status every 4 seconds
        ...
        return {
            ...
            async placeOrder() {
                ...
                try {
                    ...
                    // Switch view directly to orders tracker so customer watches progress immediately
                    setTimeout(() => {
                        showSection('orders');
                    }, 400);
    ...
    /**
     * Real-time Chat Support Component (Laravel Echo + Reverb WebSocket)
     */
