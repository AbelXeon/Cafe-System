...
<aside :class="mobileNavOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
    ...
    <div class="flex flex-col min-h-0">
        ...
        <nav class="p-4 space-y-4 overflow-y-auto custom-scroll">
            ...
            <div class="space-y-1">
                ...
                <button @click="currentView = 'orders'; mobileNavOpen = false; $nextTick(() => lucide.createIcons())" 
                ...
                <button @click="currentView = 'stock'; mobileNavOpen = false; $nextTick(() => lucide.createIcons())" 
            ...
            <!-- Account Settings (Under Audio Notification) -->
            <div class="space-y-1 pt-2 border-t border-[#1e1c25]">
                <span class="px-3 text-[10px] font-bold uppercase tracking-wider text-stone-500 block">Preferences</span>
                <button @click="currentView = 'profile'; mobileNavOpen = false; $nextTick(() => lucide.createIcons())" 
                        :class="currentView === 'profile' ? 'active' : ''" 
                        class="side-link w-full text-left px-3.5 py-2.5 rounded-xl text-sm font-semibold flex items-center justify-between cursor-pointer">
                    <div class="flex items-center gap-3">
                        <i data-lucide="settings" class="w-4 h-4 text-[#b08d57]"></i>
    ...
    <div class="p-4 border-t border-[#1e1c25] shrink-0 bg-[#0f0e13]">
        <div class="flex items-center gap-3 mb-3 px-2 cursor-pointer" @click="currentView = 'profile'; mobileNavOpen = false; $nextTick(() => lucide.createIcons())">
