<!-- VIEW 3: Account & Kitchen Profile Settings -->
<main x-show="currentView === 'profile'" class="flex-1 overflow-y-auto p-4 sm:p-8 lg:p-12 custom-scroll bg-[#14131a]/40 w-full">
    <div class="max-w-4xl mx-auto pb-20 space-y-6 sm:space-y-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-stone-400 text-xs sm:text-sm mt-1">Manage your staff profile identity, security credentials, and kitchen station access</p>
            </div>
            <div class="flex items-center gap-2 self-start sm:self-auto bg-[#14131a] border border-[#2a2731] rounded-xl px-3 py-1.5 shadow-inner">
                ...
                <span class="text-xs font-semibold text-stone-300 capitalize">{{ Auth::user()->role->name ?? 'Kitchen Staff' }}</span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-4">
            <div class="bg-[#14131a] border border-[#2a2731] rounded-2xl p-4 sm:p-5 flex items-center gap-4 shadow-lg">
                ...
                <div>
                    <span class="text-xs text-stone-500 font-medium block">Active Tickets</span>
                    <span class="text-lg sm:text-xl font-black text-white" x-text="orders.length"></span>
                </div>
            </div>
            ...
            <div class="bg-[#14131a] border border-[#2a2731] rounded-2xl p-4 sm:p-5 flex items-center gap-4 shadow-lg">
                ...
                <div>
                    <span class="text-xs text-stone-500 font-medium block">86'd Items</span>
                    <span class="text-lg sm:text-xl font-black text-rose-400" x-text="outOfStockCount"></span>
                </div>
            </div>
            ...
            <div class="bg-[#14131a] border border-[#2a2731] rounded-2xl p-4 sm:p-5 flex items-center gap-4 shadow-lg">
                ...
                <div>
                    <span class="text-xs text-stone-500 font-medium block">Staff Since</span>
            ...
            <div class="flex items-center justify-between pb-5 border-b border-[#1e1c25]">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-stone-500">Update your name and primary contact details</p>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-between pb-5 border-b border-[#1e1c25]">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-stone-500">Ensure your staff account uses a secure password</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-[#14131a] border border-rose-900/30 rounded-2xl p-5 sm:p-7 shadow-xl">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-xs text-stone-500 mt-0.5">End your staff shift session securely</p>
                </div>
